...
installDeps() {
    ...
    for dnf_package in libapparmor apparmor-parser blobfuse ca-certificates cifs-utils conntrack-tools cracklib dnf-automatic ebtables ethtool fuse git iotop iproute ipset iptables jq logrotate lsof nmap-ncat nfs-utils pam pigz psmisc rsyslog socat sysstat traceroute util-linux xz zip; do
